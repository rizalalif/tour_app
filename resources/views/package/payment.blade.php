    ...
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        <div class="mx-auto max-w-5xl">
            ...
            <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12">
                <form action="{{route('package.payment',)}}" method="post" class="w-full rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6 lg:max-w-xl lg:p-8" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-6 grid grid-cols-2 gap-4">
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <input type="text" id="full_name" value="{{$transaction->user->name}}" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" placeholder="Bonnie Green" required />
                        </div>
                        <div class="col-span-2 sm:col-span-1">
                            <label for="proof" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Your Payment Proof </label>
                            <input type="file" name="proof" id="proof" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" placeholder="Bonnie Green" required />
                        </div>
                    ...
                    <div class="space-y-4 rounded-lg border border-gray-100 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800">
                        <div class="space-y-2">
                            <dl class="flex items-center justify-between gap-4">
                                <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Price per pax</dt>
                                <dd class="text-base font-medium text-gray-900 dark:text-white">{{$transaction->holiday_package->price}}</dd>
                            </dl>

                            <dl class="flex items-center justify-between gap-4">
                                <dt class="text-base font-normal text-gray-500 dark:text-gray-400">People</dt>
                                <dd class="text-base font-medium text-green-500">{{$transaction->total_pax}}</dd>
                            </dl>

                            <dl class="flex items-center justify-between gap-4">
                                <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Package</dt>
                                <dd class="text-base font-medium text-gray-900 dark:text-white">{{$transaction->holiday_package->name}}</dd>
                            </dl>

                            <dl class="flex items-center justify-between gap-4">
                                <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Departure</dt>
                                <dd class="text-base font-medium text-gray-900 dark:text-white">{{$transaction->departure}}</dd>
                            </dl>
                        </div>

                        <dl class="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
                            <dt class="text-base font-bold text-gray-900 dark:text-white">Total</dt>
                            <dd class="text-base font-bold text-gray-900 dark:text-white">{{$transaction->total_amount}}</dd>
                        </dl>
                    </div>
